...
#include "adjntEchemConcCOFvPatchScalarField.H"
...
Foam::scalar Foam::adjntEchemConcCOFvPatchScalarField::t() const
{
...
Foam::adjntEchemConcCOFvPatchScalarField::
adjntEchemConcCOFvPatchScalarField
(
    const fvPatch& p,
...
adjntEchemConcCOFvPatchScalarField
(
    const adjntEchemConcCOFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::adjntEchemConcCOFvPatchScalarField::autoMap
(
...
void Foam::adjntEchemConcCOFvPatchScalarField::rmap
(
...
)
{
    ...
    const adjntEchemConcCOFvPatchScalarField& tiptf =
        refCast<const adjntEchemConcCOFvPatchScalarField>(ptf);
}


void Foam::adjntEchemConcCOFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::adjntEchemConcCOFvPatchScalarField::write
(
    Ostream& os
) const
{
