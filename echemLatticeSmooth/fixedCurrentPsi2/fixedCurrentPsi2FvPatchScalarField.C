...
#include "fixedCurrentPsi2FvPatchScalarField.H"
...
Foam::scalar Foam::fixedCurrentPsi2FvPatchScalarField::t() const
{
...
Foam::fixedCurrentPsi2FvPatchScalarField::
fixedCurrentPsi2FvPatchScalarField
(
    const fvPatch& p,
...
fixedCurrentPsi2FvPatchScalarField
(
    const fixedCurrentPsi2FvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::fixedCurrentPsi2FvPatchScalarField::autoMap
(
...
void Foam::fixedCurrentPsi2FvPatchScalarField::rmap
(
...
)
{
    ...
    const fixedCurrentPsi2FvPatchScalarField& tiptf =
        refCast<const fixedCurrentPsi2FvPatchScalarField>(ptf);
}


void Foam::fixedCurrentPsi2FvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    const fvPatchField& Psi2 =
        patch().lookupPatchField<volScalarField, scalar>("Psi2");
    ...
    scalarField kappa2_field(Psi2.size(),kappa2.value());
...
void Foam::fixedCurrentPsi2FvPatchScalarField::write
(
    Ostream& os
) const
{
